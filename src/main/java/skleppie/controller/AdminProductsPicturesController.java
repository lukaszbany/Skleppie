...
public class AdminProductsPicturesController {
    ...
    private void copyFileToResources(MultipartFile file) throws IOException {
        byte[] bytes = file.getBytes();
        File newFile = new File( productPictureService.PRODUCT_PICTURES_PATH + "/" + file.getOriginalFilename());
